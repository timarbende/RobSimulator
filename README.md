...
Clone and open the repository with Unity 2022.3.32f1

## Run

Build the project onto your Meta Quest device with the android build target selected

## Controls

The game can only be controlled with the Meta Quest controllers. You can move around with the left stick or initiate teleport with the right stick. You can interact with objects and collect collectibles by holding the lower trigger on either controller.
